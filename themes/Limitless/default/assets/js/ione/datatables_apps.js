...
$(function () {
        ...
        columnDefs: [
            {
                render: function (data, type, row) {
                    return '<div class = "display-inline-block text-default letter-icon-title">' + row.no + '</div>';
                },
                orderable: false,
                targets: 0
            },
            {
                render: function (data, type, row) {
                    ...
                    return '<div class = "display-inline-block text-default letter-icon-title">' + data + '</div>';
                },
                orderable: false,
                targets: 1
            },
            {
                render: function (data, type, row) {
                    ...
                    return '<div class="media-body">' +
                        '<a href="' + JS_BASE_URL + '/planning/id/' + row.id + '" class="display-inline-block font-weight-semibold">' + data + '</a>' +
            ...
            },
            {
                render: function (data, type, row) {
                    ...
                    return '<div class = "display-inline-block text-default letter-icon-title">' + row.customer + '</div>';
                },
                orderable: false,
                visible: false,
                targets: 6
            ...
            },
            {
                render: function (data, type, row) {
                    var action_menu = '<ul class="icons-list">' +
                        ...
                        '<li><a class = "edit_project" project_id = "' + row['id'] + '" source = "list"><i class="icon-pencil5"></i>Edit Project</a></li>' +
                        '</ul>' +
                        '</li>' +
                        '</ul>';
                    return action_menu;
        ...
        columnDefs: [
            ...
            },
            {
                render: function (data, type, row) {
                    ...
                    return '<span class="text-size-small text-default">' + moment(row.join_date_to_project).format('DD-MM-YYYY') +'</span>';
                },
                orderable: true,
                targets: 2
            },
            {
                render: function (data, type, row) {
                    ...
                    return '<span class="text-size-small text-default">' + row.loc + '</span>';
                },
                orderable: false,
                targets: 3
            },
            {
                render: function (data, type, row) {
                    var action_menu = '<ul class="icons-list pull-right">' +
                        ...
                        '<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu7"></i></a>' +
                        '<ul class="dropdown-menu dropdown-menu-right">' +
                        '<li><a href="#" res_id = "'+row.id+'" class = "edit_rp" ><i class="icon-pencil"></i>Edit Resource</a></li>' +
                        '<li><a href="#" res_id = "'+row.id+'" class = "delete_rp" ><i class="icon-trash"></i>Delete </a></li>' +
                        '</ul>' +
                        '</li>' +
                        '</ul>';
                    return action_menu;
    ...
    $('.datatable-user-list').dataTable({
        ...
        columnDefs: [
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default"> ' + row.user_id + '</span>';
            ...
            },
            {
                render: function (data, type, row) {
                    // return '<span class="text-size-small text-default"> ' + row.fullname + '</span>';
                    return '<a href="#" class = "edit-user" user_id = "' + row.user_id + '">' + row.fullname + '</a>'
            ...
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.department_name + '</span>';
                },
                orderable: false,
                targets: 3
            },
            ...
            },
            {
                render: function (data, type, row) {
                    var a = '';
                    if(row.active ==  1){
                        a = '<a class="label label-flat border-green text-success active" user_id = "' + row.user_id + '" title = "Deactive User">Active</span> ';
                    } else {
                        a = '<a class="label label-flat border-danger text-danger inactive" user_id = "' + row.user_id + '" title = "Activate User">Inactive</span> ';
                    }
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var action_menu = '<a href="#" class = "edit-user" user_id = "' + row.user_id + '"><i class="icon-pencil"></i></a>'
                    /*var action_menu = '<ul class="icons-list">' +
                        '<li class="dropdown">' +
                        '<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu7"></i></a>' +
                        '<ul class="dropdown-menu dropdown-menu-right">' +
    ...
    $('.datatable-issue-risk-list').dataTable({
        ...
        columnDefs: [
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default"> ' + row.issue_no + '</span>';
                },
                orderable: false,
                targets: 0
            },
            {
                render: function (data, type, row) {
                    ...
                    return '<a href="#" class = "detail-issue-risk" issue_risk = "' + row.id + '">'+issue_risk+'</a>';
                },
                orderable: false,
                targets: 1
            },
            ...
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.project_scope + '</span>';
                },
                orderable: false,
                targets: 3
            },
            {
                ...
                render: function (data, type, row) {
                    if (row.target_to_close == ""){
                        ...
                        row.target_to_close = moment(row.target_to_close).format('DD-MM-YYYY');
                    }
                    if (row.over == 0){
                        return '<span class="text-size-small text-default">' + row.target_to_close + '</span>';
                    } else {
                        return '<span class="text-size-small text-danger-600">' +row.target_to_close + '</span>';
                    }
                },
                orderable: false,
                targets: 7
                ...
                render: function (data, type, row) {
                    var a = "", b = "";
                    if(row.closable == 0 ){
                        a = '<span class="label label-flat border-grey text-grey-600">Close</span> ';
                        /*a = 'style = "pointer-events:none;"';
                        b = "disabled"*/

                    } else if(row.status == 'CLOSE'){
                        a = '<span class="label label-flat border-grey text-grey-600">'+row.status+'</span> ';
                    }else {
                        a = '<a href="#" title="Closed" class = "issue_close '+b+'" issue_risk = "' + row.id + '" '+a+'><span class="label label-flat border-danger text-danger-600">'+row.status+'</span></i></a> ';
                    }

                    if (row.status == 'OPEN'){
                        b = '<a href="#" title="Follow up" class = "issue_follow_up" issue_risk = "' + row.id + '"><span class="label label-flat border-primary text-primary-600">Follow Up</span></a> ';
                    } else {
                        b = '<span class="label label-flat border-grey text-grey-600">Follow Up</span> ';
                    }
                ...
                render: function (data, type, row) {
                    return '<a href="#" title="Attachment" class = "issue_attachment" issue_risk = "' + row.id + '"><i class = "icon-attachment"><span class="badge bg-warning-400">'+row.attc+'</span></i></a> ';
    ...
    $('.datatable-vendor-list').dataTable({
        ...
        columnDefs: [
            ...
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.vendor_address + '</span>';
                },
                orderable: false,
                targets: 2
            },{
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.vendor_phone + '</span>';
                },
                orderable: false,
                targets: 3
            },
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.vendor_email + '</span>';
                },
                orderable: false,
                targets: 4
            },{
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.other_details + '</span>';
                },
                orderable: false,
                targets: 5
            },
            {
                render: function (data, type, row) {
                    var action_menu = '<ul class="icons-list">' +
                        ...
                        '<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu7"></i></a>' +
                        '<ul class="dropdown-menu dropdown-menu-right">' +
                        '<li><a href="#" class = "edit-vendor" vendor_id = "' + row.id + '"><i class="icon-pencil"></i>Edit</a></li>' +
    ...
    $('.datatable-issuecategory-list').dataTable({
        ...
        columnDefs: [
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default"> ' + row.id + '</span>';
            ...
            },
            {
                render: function (data, type, row) {
                    // return '<span class="text-size-small text-default"> ' + row.fullname + '</span>';
                    return '<span class="text-size-small text-default"> ' + row.issue_category + '</span>';
    ...
    $('.datatable-rules-list').dataTable({
        ...
        columnDefs: [
            ...
            },
            {
                render: function (data, type, row) {
                    // return '<span class="text-size-small text-default">' + row.role_name + '</span>';
                    return '<a href="#" class = "detail-rule" rule_id = "' + row.id + '">'+row.role_name+'</a>';
                },
                orderable: false,
                targets: 1
            },
            {
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.name + '</span>';
                },
                orderable: false,
                targets: 2
            },{
                render: function (data, type, row) {
                    return '<span class="text-size-small text-default">' + row.point + '</span>';
                },
                orderable: false,
                targets: 3
            },{
                render: function (data, type, row) {
                    var action_menu = '<ul class="icons-list">' +
                        ...
                        '<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-menu7"></i></a>' +
                        '<ul class="dropdown-menu dropdown-menu-right">' +
                        '<li><a href="#" class = "edit-rules" rule_id = "' + row.id + '"><i class="icon-pencil"></i>Edit</a></li>' +
                        // '<li><a href="#" class = "delete-vendor" vendor_id = "' + row.id + '"><i class="icon-trash"></i>Delete</a></li>' +
                        '</ul>' +
                        '</li>' +
                        '</ul>';
...
var CallbackProject = function () {
    $('.edit_project').on('click', function () {
            ...
            success: function (res) {
                if (res.status == 'Success') {
                    ...
                    $.each(res.data, function (i, val) {
                        ...
                        list_user += '<option value="' + val.user_id + '"' + slctd + ' >' + val.fullname + '</option> ';
                    });
                }
            }
        });
            ...
            success : function (res) {
                if (res.status = 'success'){
                    $.each(res.data, function(i, val){
                        ...
                        list_leader += '<option value="' + val.user_id + '"' + slctd + ' >' + val.fullname + '</option> ';
                    });
                }
            }
        });
            ...
            success: function (res) {
                if (res.status == 'Success') {
                    $.each(res.data, function (i, val) {
                        ...
                        list_customer += '<option value="' + val.customer_name + '" ' + slctd + '>' + val.customer_name + '</option> ';
                    });
                }
            }
        });
            ...
            success: function (res) {
                if (res.status == 'Success') {
                    $.each(res.data, function (i, val) {
                        ...
                        list_status += '<option value="' + val.status + '" ' + slctd + '>' + val.status + '</option> ';
                    });
                }
            }
        });
            ...
            success : function (res){
                if(res.status == 'success'){
                    $.each(res.data, function (i, val) {
                        ...
                        list_area += '<option value="' + val.location + '"  ' + slctd + '>' + val.location + '</option> ';
                    });
                }
            }
        });
        ...
        bootbox.dialog({
                ...
                '<div class="input-group">'+
                '<input type="number" step = "0.01" class="form-control" id = "baseline" name = "baseline" value = "'+baseline+'">'+
                '<span class="input-group-addon">%</span>'+
                '</div>'+
                '</div>'+
        ...
        if (startDate !== null && startDate !== '0000-00-00') {
            ...
            var bulan_ini = moment().startOf('month').format('DD-MM-YYYY')
            $('#start_date').daterangepicker({
                singleDatePicker: true,
                startDate : bulan_ini,
                locale: {
        ...
        if (endDate !== null && endDate !== '0000-00-00') {
            ...
            var bulan_depan = moment().startOf('month').add(1, 'M').format('DD-MM-YYYY')
            // $('#end_date').val('test');
            $('#end_date').daterangepicker({
                singleDatePicker: true,
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if(res.status == "success"){
                    ...
                    $('#all_project').parent().addClass('checked');
                } else {
                    $('#all_project').parent().removeClass('checked');
...
var CallbackIssueRisk = function () {
    ...
    $('.detail-issue-risk').on('click', function () {
        ...
        if(detail.file_attachment== null){
            ...
            var link = '<a target = "_blank" href="'+js_base+'/assets/file/issue_risk/'+detail.file_attachment+'" class = "detail-issue-risk">Download File</a>'
        }
        ...
        $("#target_to_close2").val(moment(detail.target_to_close).format('DD-MM-YYYY'));
                    ...
                    if(followUp !== undefined){
                        $.each(res.data, function (i, val) {
                            ...
                            if (val.file == null){
                                ...
                                row += '<td><span>'+val.type+'</span></td><td><span>'+val.date+'</span></td><td><span>'+val.desc+'</span></td><td><span title = "No Attachment"><i class ="icon-file-download"></i></span></td>';
                                row +='</tr>';
                            } else {
                                row +='<tr class = "prepend">';
                                row += '<td><span>'+val.type+'</span></td><td><span>'+val.date+'</span></td><td><span>'+val.desc+'</span></td><td><a target = "_blank" href="'+js_base+'/assets/file/issue_risk/'+val.file+'" class = "detail-issue-risk"><i class ="icon-file-download"></i></a>';
                                row +='</tr>';
                            }
                            count++;
                ...
                if (res.status == 'Success') {
                    ...
                    if(followUp !== undefined){
                        $.each(res.data, function (i, val) {
                            var js_base = JS_BASE_URL.replace('index.php', '');
                            row +='<tr class = "prepend">';
                            row += '<td><input type="text" disabled = "disabled" value = "'+val.follow_up_date+'" class="form-control daterange-single"></td><td><textarea disabled = "disabled" type="text" class="form-control">'+val.follow_up_description+' </textarea></td><td><a target = "_blank" href="'+js_base+'/assets/file/issue_risk/'+val.file_attachment+'" class = "detail-issue-risk">Download File</a><td><a href="#" class ="dismiss" follow_up = "'+val.id+'"><i class ="icon-trash"></i></span></td></td>';
                            row +='</td></tr>';
                            count++;
                        });
                        row += '<tr class = "prepend"><td><input type="text" name = "follow_up['+count+'][date]" class="form-control daterange-single"></td><td><textarea type="text" name = "follow_up['+count+'][description]" class="form-control"></textarea></td><td><input type="file" name = "attachment'+count+'" class="form-control"> </td><td></tr>';
                        $('#idx').val(count); 
                        $('#closing').show();
                    ...
                    var row = '<tr class = "prepend"><td><input type="text" name = "follow_up[0][date]" class="form-control daterange-single"></td><td><textarea rows="2" name = "follow_up[0][description]" class="form-control"></textarea></td><td><input type="file" name = "attachment0" class="form-control"> </td><td></tr>';
                    $('#idx').val(0);
                    $("#follow_up tbody").append(row);
                    $('.daterange-single').daterangepicker({
                        singleDatePicker: true,
                ...
                if (res.status == 'Success') {
                    ...
                    if(followUp !== undefined){
                        $.each(res.data, function (i, val) {
                            var js_base = JS_BASE_URL.replace('index.php', '');
                            row +='<tr class = "prepend">';
                            row += '<td><span>'+val.follow_up_date+'</span></td><td><span>'+val.follow_up_description+'</span></td><td><a target = "_blank" href="'+js_base+'/assets/file/issue_risk/'+val.file_attachment+'" class = "detail-issue-risk">Download File</a>';
                            row +='</tr>';
                            count++;
                        });
            ...
            success: function (res) {
                ...
                if (res.status == 'Success') {
                    $.each(res.data, function (i, val) {
                        var js_base = JS_BASE_URL.replace('index.php', '');
                        row +='<tr class = "prepend">';
                        row += '<td><span>'+val.date+'</span></td><td><a target = "_blank" href="'+js_base+'/assets/file/issue_risk/'+val.file_attachment+'" class = "detail-issue-risk">Download File</a><td><span>'+val.type+'</span></td>';
                        row +='</tr>';
                    });
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == 'success'){
                    ...
                    $("#resource_position").val(detail.position_id).trigger("change");
                    // if(detail.loc != null){
                        detail.loc = detail.loc.split(",");
                        $("#resource_area").val(detail.loc).trigger("change");
                    // }
                    $("#resource_join_date").val(moment(detail.join_date_to_project).format('DD-MM-YYYY'));
                }
            }
        });
